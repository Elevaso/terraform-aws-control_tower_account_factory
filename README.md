...
| <a name="input_aft_framework_repo_url"></a> [aft\_framework\_repo\_url](#input\_aft\_framework\_repo\_url) | Git repo URL where the AFT framework should be sourced from | `string` | `"https://github.com/Elevaso/terraform-aws-control_tower_account_factory.git"` | no |
...
| <a name="input_terraform_project_name"></a> [terraform\_project\_name](#input\_terraform\_project\_name) | Project name for creating workspaces in Terraform Cloud or Enterprise | `string` | `"Default Project"` | no |
