...
def setup_workspace(
    ...
    print(
        "Successfully created workspace {} with ID {} in {} Project".format(
            workspace_name, workspace_id, project_name
        )
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--project_name", type=str, help="Terraform Project Name for Workspace Creation")
